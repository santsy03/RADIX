...
port = PORTS['ussd']['41114']
threads = THREADS['ussd']

SiteServer = MenuService()
SiteService = internet.TCPServer(port, server.Site(SiteServer))
SiteService.setName('modular41114-ussd')
application = service.Application('modular41114-ussd')
SiteService.setServiceParent(application)
logfile = DailyLogFile("logs/twistd.log-modular41114-ussd", ".")
