...
class ModularResponsesClient(object):
    def __init__(self,request):
        from pika.adapters import SelectConnection
        from modular_tariffs.src.configs import QUEUES
        self.queue = QUEUES['modular_responses']
        self.response = None
        self.channel = None
...
if __name__ == '__main__':
    msg = {'msisdn':'261336173681','package_requested':'1','transactionId':'2013','statusCode':'5','packageName':'clubsms','expiry':'','transaction_id':'123','transaction_type':'a','b_msisdn':'261336173681'}
    print ModularResponsesClient(str(msg))
