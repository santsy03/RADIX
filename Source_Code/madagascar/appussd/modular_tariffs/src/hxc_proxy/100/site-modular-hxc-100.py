...
hxcProxyService.setName('modular_hxc_proxy_100')
application = service.Application('modular_hxc_proxy_100')
logfile = DailyLogFile("logs/twistd.log-modular-hxcproxy100",".")
