        ...
        if status == 5:
            ...
            #End of Bonus Messages
                ...
                if package_id == '32':
                    ...
                    if package_id in ['209','211','213','215','217','218','219']:
                ...
                if hour >= 12 and hour < 17:
                    message = messages['success_mymeg_10_afte']
                else:
                    message = messages['success_mymeg_10_morn']
            elif is_night == 'True':
                message = messages['success_night'].safe_substitute(
                message = newMsgs[package_id][lang])
            elif is_night == 'True':
                ...
                message = messages['success_fb_weekly']
