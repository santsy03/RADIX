...
class AIRHandler:
    ...
    def __init__(self, params, host, originHostName = 'radix'):
        ...
        self.basicRequest =  {}
        self.airHost = host
        print "AIR HOST is :::%s" %str(self.airHost) 
    ...
    def GetUsageThresholdsAndCounters( self, msisdn):
        ...
        try:
            ...
            self.logger.error("AirHost:%s-%s-%s" %(self.airHost, msisdn, str(err)))
            #raise err
...
if __name__ == "__main__":
    ...
    svr = AIRHandler({'transactionId':'65433','externalData1':'data','externalData2':'data'}, hosts[0])
    ...
    #print svr.getBalanceAndDate('254735618959')
