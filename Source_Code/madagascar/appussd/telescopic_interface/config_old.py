...
#message['txt-2']['first_before_one'] = "Tontosa ny fangatahanao hamplasa ny MyMeg30, manankery adiny 4.Ny saran ny fidiranao fanindroaany dia hihena ho 150 Ariary. Misaotra tompoko"
...
message['txt-2']['first_after_one'] = "Tontosa ny fanfatahanao hampiasa ny MyMeg30, manankery hatr@5 hariva. Ny saran ny fidiranao fanindroaany dia hihena ho 150 Ariary. Misaotra tompoko"
...
message['txt-1']['second_before_three'] = "Your second subscription to MyMeg30 is successfully executed, offer valid 2 hours. Your third subscription will be free. Thank you"

#message['txt-2']['second_before_three'] = "Tontosa ny fampidiranao fanindroany ny MyMeg30, mananakery adiny 2.Ny saran ny fidiranao fanintelony androany dia ho maimaim-poana. Misaotra tompoko."
...
message['txt-3']['second_before_three'] = "Votre 2eme souscription a MyMeg30 est executee, valable pendant 2h. Votre 3eme souscription de la journee sera gratuite.Merci"


message['txt-1']['second_after_three'] = "Your second subscription to MyMeg30 is successfully executed, offer valid till 5 pm. Your third subscription will be free. Thank you"

message['txt-2']['second_after_three'] = "Tontosa ny fampidiranao ny MyMeg30, manankery hatr@ 5 hariva. Ny saran ny fidiranao fanintelony androany dia ho maimaim-poana. Misaotra tompoko"

message['txt-3']['second_after_three'] = "Votre 2eme souscription a MyMeg30 est executee, offre valable jusqu a 17h. Votre 3eme sourscription de la journee sera gratuite. Merci"

message['txt-1']['third'] = "Your third subscription to MyMeg30 is successfully executed, offer valid till 5 pm. Thank you"

message['txt-2']['third'] = "Tontosa ny fampidiranao fanintelony ny MyMeg30, manankery hatr@5 hariva. Misaotra tompoko"
