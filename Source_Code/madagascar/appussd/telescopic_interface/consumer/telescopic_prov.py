...
from telescopic_interface.config import LOG_NAME, PID_FILE, CWD, ROUTING_KEY, queue_name
from telescopic_interface.core import execute_provision_response 
from telescopic_interface.consumer.daemon import Daemon
...
class Consumer(object):
    ...
    def handle_delivery(self, channel, method, header, body):
        try:
            import traceback
            msg = json.loads(eval(body))
            self.logger.debug(msg)
            execute_provision_response(msg, self.logger)
