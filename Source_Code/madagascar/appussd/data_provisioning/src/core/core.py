...
from aapcn.src.voice.config import (voice_bundles_to_be_recorded,
        ...
        retailer_packages_check,weekend_check_packages)
...
def processRequest(resources):
    ...
    if int(packageId) != 0:
        ...
        if packageCategoryName == 'volume':
            from aapcn.src.volume.core import provisionBundle,checkConflictingBundles,getBalance,is_barred,is_barred_MyMeg5
            ...
            from aapcn.src.voice.core import provisionBundle,checkConflictingBundles,getBalance,is_barred,is_time_barred,voice_offer_deletion,is_whitelisted
        ...
        if (is_barred == False) and within_time_limits and (my_meg5_barred == False) and (voice_time_barred == False) and whitelisted:
