...
from mg_aapcn_me2u.hxc_proxy.core import get_performance
from mg_aapcn_me2u.hxc_proxy.core import getSubscriberType
from mg_aapcn_me2u.hxc_proxy.core import getSubscriberLanguage
...
from mg_aapcn_me2u.hxc_proxy.config import error_ussd
from mg_aapcn_me2u.hxc_proxy.config import MSISDNS as msisdns
from mg_aapcn_me2u.hxc_proxy.config import APPLICATIONS as applications
from mg_aapcn_me2u.hxc_proxy.config import WHITELIST
...
class MenuService(xmlrpc.XMLRPC):
    ...
    def processRequest(self,resources):
        ...
        try:
            url = applications['177'][type]
            print url
            proxy = xmlrpclib.ServerProxy(url)
            response = proxy.handle_request(parameters)
        except Exception,e:
